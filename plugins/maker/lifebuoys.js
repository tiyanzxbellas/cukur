// File: plugins/maker/lifebuoys.js
'use strict';
...
module.exports = {
  ...
  name:        'Lifebuoys',
  category:    'Maker',
  path:        '/api/maker/lifebuoys',
  method:      'GET',
  description: 'Generate Lifebuoys text image.',
  ...
  handler: async (req, getInput, res) => {
    ...
    try {
      const { data } = await axios.get('https://api.neoxr.eu/api/lifebuoys', {
        params: {
          text1,
          text2,
          apikey: 'yMb35i',
