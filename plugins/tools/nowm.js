...
module.exports = {
  ...
  path:        '/api/tools/nowm',
  method:      'GET',
  description: 'No Watermark via Neoxr API.',

  params: [
    { name: 'image', required: true, example: 'https://cdn.neoxr.eu/images/image-with-watermark.jpg', description: 'URL gambar', isMedia: true, isImage: true },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${NEOXR_BASE}/nowm`, {
