...
module.exports = {
  ...
  name:        'Identify',
  category:    'Tools',
  path:        '/api/tools/identify',
  method:      'GET',
  description: 'Identifikasi objek pada gambar.',

  params: [
    { name: 'image', required: true, example: 'https://cdn.neoxr.eu/images/image.jpg', description: 'URL gambar', isMedia: true, isImage: true },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${NEOXR_BASE}/identify`, {
