...
module.exports = {
  ...
  path:        '/api/tools/ocr',
  method:      'GET',
  description: 'Baca teks dari gambar (Optical Character Recognition).',

  params: [
    { name: 'image', required: true, example: 'https://telegra.ph/file/b7234237a2477dda1fecb.jpg', description: 'URL gambar', isMedia: true, isImage: true },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${NEOXR_BASE}/ocr`, {
