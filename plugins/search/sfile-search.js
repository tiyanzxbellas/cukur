// File: plugins/search/sfile-search.js
'use strict';
...
module.exports = {
  ...
  method:      'GET',
  description: 'SFile Search via Neoxr API.',

  params: [
    {
      name:        'q',
      required:    true,
      example:     'config indosat',
      description: 'Query pencarian file di SFile.co',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/sfile-search`, {
