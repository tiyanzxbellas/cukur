// File: plugins/search/tiktok-content-search.js
'use strict';
...
module.exports = {
  id:          'search-tiktok-content',
  name:        'TikTok Content Search',
  category:    'Search',
  path:        '/api/search/tiktok-content',
  method:      'GET',
  description: 'TikTok Content Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'cat funny',
      description: 'Query pencarian konten TikTok',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/tiktok-search-content`, {
