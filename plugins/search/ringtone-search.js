// File: plugins/search/ringtone-search.js
'use strict';
...
module.exports = {
  ...
  method:      'GET',
  description: 'Ringtone Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'jokowi',
      description: 'Query pencarian ringtone',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/ringtone`, {
