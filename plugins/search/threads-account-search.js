// File: plugins/search/threads-account-search.js
'use strict';
...
module.exports = {
  id:          'search-threads-account',
  name:        'Threads Account Search',
  category:    'Search',
  path:        '/api/search/threads-account',
  method:      'GET',
  description: 'Threads Account Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'neoxr',
      description: 'Query pencarian akun Threads',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/threads-search-account`, {
