// File: plugins/search/pinterest-search.js
'use strict';
...
module.exports = {
  ...
  method:      'GET',
  description: 'Pinterest Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'cat',
      description: 'Query pencarian gambar di Pinterest',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/pinterest`, {
