// File: plugins/search/roblox-search.js
'use strict';
...
module.exports = {
  ...
  category:    'Search',
  path:        '/api/search/roblox',
  method:      'GET',
  description: 'Roblox User Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'linkmon',
      description: 'Query pencarian user Roblox',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/roblox-search`, {
