// File: plugins/search/tiktok-account-search.js
'use strict';
...
module.exports = {
  id:          'search-tiktok-account',
  name:        'TikTok Account Search',
  category:    'Search',
  path:        '/api/search/tiktok-account',
  method:      'GET',
  description: 'TikTok Account Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'hosico',
      description: 'Query pencarian akun TikTok',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/tiktok-search-account`, {
