// File: plugins/search/spotify-search.js
'use strict';
...
module.exports = {
  ...
  method:      'GET',
  description: 'Spotify Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'komang',
      description: 'Query pencarian lagu di Spotify',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/spotify-search`, {
