// File: plugins/search/wa-group-search.js
'use strict';
...
module.exports = {
  ...
  category:    'Search',
  path:        '/api/search/wa-group',
  method:      'GET',
  description: 'WhatsApp Group Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'cuan',
      description: 'Query pencarian grup WhatsApp',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/whatsapp-group`, {
