// File: plugins/search/gsmarena-search.js
'use strict';
...
module.exports = {
  ...
  method:      'GET',
  description: 'GSMArena Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'oppo a3s',
      description: 'Query pencarian spesifikasi HP di GSMArena',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/gsmarena`, {
