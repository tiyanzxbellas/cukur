// File: plugins/search/yts-search.js
'use strict';
...
module.exports = {
  ...
  path:        '/api/search/yts',
  method:      'GET',
  description: 'YouTube Search via Neoxr API.',

  params: [
    {
      name:        'q',
      required:    true,
      example:     'komang raim laode',
      description: 'Query pencarian YouTube',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/yts`, {
