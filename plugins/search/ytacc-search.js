// File: plugins/search/ytacc-search.js
'use strict';
...
module.exports = {
  id:          'search-ytacc',
  name:        'YouTube Account Search',
  category:    'Search',
  path:        '/api/search/ytacc',
  method:      'GET',
  description: 'YouTube Account Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'mr beast',
      description: 'Query pencarian akun YouTube',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/ytacc`, {
