// File: plugins/search/threads-content-search.js
'use strict';
...
module.exports = {
  id:          'search-threads-content',
  name:        'Threads Content Search',
  category:    'Search',
  path:        '/api/search/threads-content',
  method:      'GET',
  description: 'Threads Content Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'cat',
      description: 'Query pencarian postingan di Threads',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/threads-search-content`, {
