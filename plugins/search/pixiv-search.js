// File: plugins/search/pixiv-search.js
'use strict';
...
module.exports = {
  ...
  name:        'Pixiv Search',
  category:    'Search',
  path:        '/api/search/pixiv',
  method:      'GET',
  description: 'Pixiv Search via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'black cat',
      description: 'Query pencarian artwork di Pixiv',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/pixiv-search`, {
