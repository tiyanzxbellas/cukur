...
module.exports = {
  ...
  name: 'Sticker Search',
  category:    'Search',
  path:        '/api/search/sticker',
  method: 'GET',
  description: 'Cari sticker pack dari GetStickerPack.',
  params: [
    { name: 'q', required: true, example: 'bear', description: 'Keyword sticker pack yang dicari' }
  ],
  handler: async (req, res) => {
    ...
    try {
      const response = await axios.get(`${BASE_URL}/sticker`, {
        params: {
          ...params,
          apikey: API_KEY
        },
