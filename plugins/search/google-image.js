...
module.exports = {
  ...
  method: 'GET',
  description: 'Cari gambar di Google Images.',
  params: [
    { name: 'q', required: true, example: 'cat', description: 'Query pencarian gambar Google' }
  ],
  handler: async (req, res) => {
    ...
    try {
      const response = await axios.get(`${BASE_URL}/goimg`, {
        params: {
          ...params,
          apikey: API_KEY
        },
