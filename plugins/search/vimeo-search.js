// File: plugins/search/vimeo-search.js
'use strict';
...
module.exports = {
  ...
  name:        'Vimeo Search',
  category:    'Search',
  path:        '/api/search/vimeo',
  method:      'GET',
  description: 'Vimeo Search via Neoxr API.',

  params: [
    {
      name:        'q',
      required:    true,
      example:     'cat shit one',
      description: 'Query pencarian video di Vimeo',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/vimeo-search`, {
