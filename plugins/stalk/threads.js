...
module.exports = {
  ...
  method:      'GET',
  description: 'Threads Stalk via Neoxr API.',

  params: [
    { name: 'username', required: true, example: 'neoxr', description: 'Username Threads' },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${NEOXR_BASE}/thstalk`, {
