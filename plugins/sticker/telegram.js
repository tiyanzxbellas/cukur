...
module.exports = {
  ...
  category:    'Sticker',
  path:        '/api/sticker/telegram',
  method:      'GET',
  description: 'Telegram Sticker via Neoxr API.',

  params: [
    { name: 'url', required: true, example: 'https://t.me/addstickers/NonromanticBear', description: 'URL sticker pack Telegram', isMedia: true },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${NEOXR_BASE}/telesticker`, {
