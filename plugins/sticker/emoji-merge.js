...
module.exports = {
  id:          'sticker-emoji-merge',
  name:        'Emoji Merge',
  category:    'Sticker',
  path:        '/api/sticker/emoji-merge',
  method:      'GET',
  description: 'Emoji Merge via Neoxr API.',

  params: [
    { name: 'q', required: true, example: '😳_😩', description: 'Kombinasi emoji (format: emoji1_emoji2)' },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${NEOXR_BASE}/emoji`, {
