...
module.exports = {
  ...
  method:      'GET',
  description: 'Cari info negara berdasarkan kode dial atau nama negara.',

  params: [
    { name: 'q', required: true, example: '62', description: 'Kode dial atau nama negara' },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${NEOXR_BASE}/country`, {
