...
module.exports = {
  ...
  name:        'Lexica AI Art',
  category:    'Random',
  path:        '/api/random/lexica',
  method:      'GET',
  description: 'Lexica AI Art via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'white cat',
      description: 'Prompt pencarian gambar AI di Lexica',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/lexica`, {
