// File: plugins/random/wallpaper-hd.js
'use strict';
...
module.exports = {
  ...
  method:      'GET',
  description: 'Wallpaper HD via Neoxr API.',
  ...
  params: [
    {
      ...
      required:    true,
      example:     'nature',
      description: 'Kata kunci tema wallpaper',
    },
  ],
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/wallpaper-hd`, {
